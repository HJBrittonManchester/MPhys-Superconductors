...
alpha_rashba = 0.  # 4.51783144e-04  # 9.03566289e-05
beta = 2.75726642e+01  # 2.74597698e+01  # 2.75681159e+01  # 1.0073e1
#
...
def GF_susc(kx, ky, omega, H, theta=np.pi/2, phi=0):
    ...
    chi = GF_up_up(kx, ky, omega, hx, hy, hz) * GF_down_down(-kx, -ky, -omega, hx, hy, hz) - \
        GF_up_down(kx, ky, omega, hx, hy, hz) * \
        GF_down_up(-kx, -ky, -omega, hx, hy, hz)

    chi = -chi / (Det(kx, ky, omega, hx, hy, hz) *
                  Det(-kx, -ky, -omega, hx, hy, hz))
